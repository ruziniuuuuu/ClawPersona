...
MODES = {
    "mirror": "photo of this elegant scholar taking a mirror selfie, {prompt}, Tsinghua campus background, intellectual atmosphere, books or laptop visible, natural lighting",
    "selfie": "close-up selfie of this elegant scholar, {prompt}, gentle smile, wearing glasses, library or study room background, warm academic atmosphere",
    "photo": "photo of this elegant scholar, {prompt}, natural pose, campus setting, soft lighting, intelligent and approachable expression",
}
...
def main():
    ...
    parser.add_argument("--filename", default="gujin.jpg")
