#!/usr/bin/env python3
"""Generate Gu Jin (scholar) selfie via Doubao Seedream API."""
...
MODES = {
    "mirror": "photo of this scholarly girl taking a mirror selfie, {prompt}, full body visible, natural pose, library or study room background, warm intellectual atmosphere, wearing glasses",
    "selfie": "close-up selfie of this scholarly girl, {prompt}, natural angle, thoughtful expression, wearing glasses, intelligent and gentle look, academic setting",
    "photo": "photo of this scholarly girl, {prompt}, natural lighting, realistic, intellectual and serene expression, study or campus setting, bookish charm",
}

def main():
    parser = argparse.ArgumentParser(description="Generate Gu Jin scholar selfies")
    ...
    parser.add_argument("--filename", default="gujin.jpg", help="Output filename")
