...
MODES = {
    "mirror": "photo of this artistic musician taking a mirror selfie, {prompt}, music studio background, guitar or piano visible, moody artistic lighting",
    "selfie": "close-up selfie of this artistic musician, {prompt}, thoughtful expression, music equipment in background, warm intimate lighting, artistic atmosphere",
    "photo": "photo of this artistic musician, {prompt}, natural pose, music studio or stage setting, soft lighting, creative and soulful expression",
}
...
def main():
    ...
    parser.add_argument("--filename", default="jiangyu.jpg")
