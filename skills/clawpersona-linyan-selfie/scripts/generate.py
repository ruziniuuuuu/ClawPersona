...
MODES = {
    "mirror": "photo of this professional businesswoman taking a mirror selfie, {prompt}, office or luxury hotel background, power suit, confident pose, city skyline visible",
    "selfie": "close-up selfie of this professional businesswoman, {prompt}, confident smile, elegant makeup, executive office background, professional lighting",
    "photo": "photo of this professional businesswoman, {prompt}, professional pose, corporate setting, natural office lighting, confident and capable expression",
}
...
def main():
    ...
    parser.add_argument("--filename", default="linyan.jpg")
