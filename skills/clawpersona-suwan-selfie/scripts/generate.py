#!/usr/bin/env python3
"""Generate Su Wan (artistic) selfie via Doubao Seedream API."""
...
MODES = {
    "mirror": "photo of this artistic girl taking a mirror selfie, {prompt}, full body visible, natural pose, soft lighting, art studio background, warm and gentle atmosphere",
    "selfie": "close-up selfie of this artistic girl, {prompt}, natural angle, intimate perspective, soft dreamy lighting, delicate features, warm color palette",
    "photo": "photo of this artistic girl, {prompt}, natural lighting, realistic, gentle expression, artistic setting, soft focus background",
}

def main():
    parser = argparse.ArgumentParser(description="Generate Su Wan artistic selfies")
    ...
    parser.add_argument("--filename", default="suwan.jpg", help="Output filename")
