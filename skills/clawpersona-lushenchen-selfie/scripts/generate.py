#!/usr/bin/env python3
"""Generate Lu Shenchen (CEO) selfie via Doubao Seedream API."""
...
MODES = {
    "mirror": "photo of this powerful CEO taking a mirror selfie, {prompt}, luxury office or penthouse background, designer suit, commanding presence, city skyline view",
    "selfie": "close-up selfie of this powerful CEO, {prompt}, intense gaze, confident expression, premium office background, dramatic lighting",
    "photo": "photo of this powerful CEO, {prompt}, authoritative pose, executive setting, professional lighting, dominant and confident expression",
}
...
def main():
    ...
    parser.add_argument("--filename", default="lushenchen.jpg")
