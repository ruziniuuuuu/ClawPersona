#!/usr/bin/env python3
"""Generate Tang Guo (sweetcool) selfie via Doubao Seedream API."""
...
MODES = {
    "mirror": "photo of this trendy girl taking a mirror selfie, {prompt}, full body visible, cute pose, trendy outfit, colorful aesthetic, Y2K style, playful and stylish",
    "selfie": "close-up selfie of this trendy girl, {prompt}, natural angle, cute expression with attitude, trendy makeup, colorful hair highlights, kawaii but cool, gen-z vibe",
    "photo": "photo of this trendy girl, {prompt}, vibrant lighting, realistic, trendy street fashion, playful pose, urban setting, youthful and energetic",
}

def main():
    parser = argparse.ArgumentParser(description="Generate Tang Guo sweetcool selfies")
    ...
    parser.add_argument("--filename", default="tangguo.jpg", help="Output filename")
