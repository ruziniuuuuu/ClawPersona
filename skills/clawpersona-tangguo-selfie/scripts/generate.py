...
MODES = {
    "mirror": "photo of this trendy girl taking a mirror selfie, {prompt}, dorm room or trendy cafe background, streetwear fashion, playful pose, colorful aesthetic",
    "selfie": "close-up selfie of this trendy girl, {prompt}, cute expression, trendy makeup, urban background, vibrant and youthful energy",
    "photo": "photo of this trendy girl, {prompt}, casual pose, street or campus setting, natural lighting, sweet and cool expression",
}
...
def main():
    ...
    parser.add_argument("--filename", default="tangguo.jpg")
